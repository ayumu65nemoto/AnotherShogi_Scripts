...
public class Effect17 : MonoBehaviour
{
    ///<summary>
    ///自分のコマ１つを進化させる
    ///</summary>
    ...
    void Start()
    {
        ...
        List<PieceController> pieces = _fieldManager.GetPieces(_fieldManager.nowPlayer);
        for (int i = 0; i < pieces.Count; i++)
        {
            if (pieces[i].isEvolution == false)
            {
                _count++;
            }
        }
